...
npx degit devstefancho/claude-code-book-sample/part-04/chapter-04/samples/skills/component-design-reviewer .claude/skills/component-design-reviewer --force
```
