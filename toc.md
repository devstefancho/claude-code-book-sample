...
### Chapter 09. 데모는 가깝고 실제 서비스는 멀게 느껴지는 현실
- 작성자와 편집자
...
### Chapter 23. 하네스 엔지니어링 이해하기
- 하네스 엔지니어링의 개념
- 하네스의 4가지 요소: 제약 설계, 품질 게이트, 포맷 강제, 피드백 루프
...
### Chapter 25. Hermes Agent에 하네스 적용하기
- 크론잡의 스킬 사용 여부 확인
- 스킬로 검증 로직 고정하기
